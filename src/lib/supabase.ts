...
// Debug: Log solo en desarrollo sin exponer claves
...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  console.error('[Supabase Client] URL configured:', !!supabaseUrl);
  console.error('[Supabase Client] Key configured:', !!supabaseAnonKey);
  throw new Error(
